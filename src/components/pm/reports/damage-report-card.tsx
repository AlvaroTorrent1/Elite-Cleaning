...
/**
 * DamageReportCard - Tarjeta de reporte de daño para PM
 * 
...
export default function DamageReportCard({ report }: DamageReportCardProps) {
  ...
  return (
    <Card
      className={`border-2 ${report.acknowledged_by_pm ? 'border-border' : 'border-primary'}`}
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          {/* Damage Item */}
          <div>
            <p className="text-sm text-muted-foreground">Item Dañado</p>
            <p className="font-semibold text-foreground">
