...
export default function LimpiadoraMensajesPage() {
  ...
  return (
    <div className="h-[calc(100vh-180px)] flex bg-gray-100 rounded-lg overflow-hidden shadow-sm mx-4">
      ...
      {/* New Chat Modal - Cleaner can only message admins */}
      <NewChatModal
